...
import static org.openhab.binding.tapocamera.internal.api.v2.TypeMethodResponse.CLOCK_STATUS;
import static org.openhab.binding.tapocamera.internal.api.v2.TypeMethodResponse.CONNECTION_TYPE;
import static org.openhab.binding.tapocamera.internal.api.v2.TypeMethodResponse.DEVICE_INFO_BASIC;
import static org.openhab.binding.tapocamera.internal.api.v2.TypeMethodResponse.DEVICE_INFO_FULL;
import static org.openhab.binding.tapocamera.internal.api.v2.TypeMethodResponse.INTRUSION_DETECTION;
import static org.openhab.binding.tapocamera.internal.api.v2.TypeMethodResponse.LAST_ALARM_INFO;
import static org.openhab.binding.tapocamera.internal.api.v2.TypeMethodResponse.LED_STATUS;
import static org.openhab.binding.tapocamera.internal.api.v2.TypeMethodResponse.LENS_MASK;
import static org.openhab.binding.tapocamera.internal.api.v2.TypeMethodResponse.LIGHT_FREQUENCY_INFO;
import static org.openhab.binding.tapocamera.internal.api.v2.TypeMethodResponse.LINECROSSING_DETECTION;
...
import static org.openhab.binding.tapocamera.internal.api.v2.TypeMethodResponse.PRESETS;
import static org.openhab.binding.tapocamera.internal.api.v2.TypeMethodResponse.SPEAKER_INFO;
import static org.openhab.binding.tapocamera.internal.api.v2.TypeMethodResponse.TAMPER_DETECTION;
import static org.openhab.binding.tapocamera.internal.api.v2.TypeMethodResponse.TARGET_TRACK;
import static org.openhab.binding.tapocamera.internal.api.v2.TypeMethodResponse.USER_ID;
import static org.openhab.binding.tapocamera.internal.api.v2.TypeMethodResponse.WAN_INFO;
import static org.openhab.binding.tapocamera.internal.api.v2.TypeMethodResponse.getClassByModuleAndSection;
import static org.openhab.binding.tapocamera.internal.api.v2.utils.ApiUtils.createMultipleCommand;
...
import org.openhab.binding.tapocamera.internal.api.v2.utils.ApiUtils;
...
public class TapoApiImpl implements TapoApi {
    ...
    public TapoApiImpl(HttpClient httpClient) {
    ...
    private Integer getUserId() {
        ...
        if (response.errorCode == 0) {
            ...
            logger.error("TapoApi error {}", response.errorCode);
        }
        return result;
    }
    ...
    private List<Object> processMethodResult(String method, JsonObject obj) {
        List<Object> result = new ArrayList<>();
        Arrays.asList(TypeMethodResponse.values()).forEach(t -> {
    ...
    @Override
    public Class<?> getParameterInfo(TypeMethodResponse type) {
        String module = type.getModule();
        String section = type.getSection();
    ...
    public List<ApiMethodResult> getChangebleParameters() {
        ...
        List<TypeMethodResponse> listCommands = List.of(
                TypeMethodResponse.MOTION_DETECTION, TypeMethodResponse.INTRUSION_DETECTION,
                TypeMethodResponse.LINECROSSING_DETECTION, TypeMethodResponse.PERSON_DETECTION,
                TypeMethodResponse.TAMPER_DETECTION,
                TypeMethodResponse.MSG_ALARM_INFO, TypeMethodResponse.LAST_ALARM_INFO, TypeMethodResponse.MSG_PUSH_INFO,
                TypeMethodResponse.NIGHT_VISION_MODE,
                TypeMethodResponse.LENS_MASK, TypeMethodResponse.LIGHT_FREQUENCY_INFO,
                TypeMethodResponse.LED_STATUS,
                TypeMethodResponse.TARGET_TRACK, TypeMethodResponse.PRESETS,
                TypeMethodResponse.SPEAKER_INFO, TypeMethodResponse.MICROPHONE_INFO
        );
